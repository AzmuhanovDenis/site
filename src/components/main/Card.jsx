...
const Card = (props) => {
    const cardStyle = props.imageUrl ? {
        background: `url(${props.imageUrl}) center center no-repeat`,
        backgroundSize: '100%'
    } : {};

    return (
        <div className={`block-img ${props.secondaryClass}`} style={cardStyle}>
            <div className="block-text">
            <div className="line"></div>
                <div className="content-wrapper">
                    <div className="text-group default">
                        <p className="text-top">{props.text_top_d}</p>
                        <p className="text-bottom">{props.text_bottom_d}</p>
                    </div>
                    <div className="text-group hover">
                        <p className="text-top">Jean-Honore Fragonard</p>
                        <p className="text-bottom">Louvre Museum</p>
                    </div>
                </div>
            </div>
